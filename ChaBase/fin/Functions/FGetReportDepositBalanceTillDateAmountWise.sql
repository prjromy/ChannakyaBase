CREATE FUNCTION [fin].[FGetReportDepositBalanceTillDateAmountWise] 
...
RETURNS @TEMP TABLE
	...
	(
		...
		AccountNumber NVARCHAR(50),AccountName NVARCHAR(100),IntToExp MONEY,InToCap MONEY,Balance MONEY
