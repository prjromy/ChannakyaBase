...
-- =============================================
CREATE FUNCTION [dbo].[GetNrmlTrialBalanceReport]
(	
...
FId int,Fname varchar(500),Tdate datetime,DebitAmount numeric(18,2) , CreditAmount numeric(18,2)--,PrYrBalDB numeric(18,2),PrYrBalCR numeric(18,2)
)
AS
BEGIN 
...
-- end 
-- as CreditAmount
DebitAmount as DebitAmount,CreditAmount as CreditAmount--,PrYrBalDB,PrYrBalCr
		from dbo.GetNormalTrialBalanceData(@myrootId,1,getdate(),0)
		--from dbo.GetTransTBData(@myrootId,@BranchId,@fromDate,@TillDate)
			group by FId,DebitAmount,CreditAmount--,PrYrBalDB,PrYrBalCr
